...
// Componente principal ListarTarefa
const ListarTarefa = () => {
  const [open, setOpen] = useState(false);
  const [openEditar, setOpenEditar] = useState(false);
  const [tarefas, setTarefas] = useState(initialRows); // Inicializado com os dados iniciais.
  const [tarefa, setTarefa] = useState(null); // Inicializado como null.
  const [idTarefaSelecionada, setIdTarefaSelecionada] = useState(null); // Inicializado como null.
  ...
  const handleEditar = (id) => {
    ...
    const tarefaParaEditar = tarefas.find((t) => t.idTarefa === id) || null;
      ...
      <Modal open={openEditar} onClose={handleCloseEditar} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        <div>
          <EditarTarefa
            ...
            tarefas={tarefas}
            tarefa={tarefa || {}} // Garante que não seja passado undefined.
